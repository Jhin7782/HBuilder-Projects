...
function kf_getPopupDivHtml(kfguin,reference,companyname,welcomeword)
{
    ...
    temp += '<a class="hidekfpopup" onclick="kf_hidekfpopup();return false;" href="#" style="float:right;background-image: url('+urlroot+'btn_1.gif);margin: 0 0 0 5px;padding: 0px;border:0px;height: 21px;width: 69px;"></a>';
...
{   
	...
	var kf_position_left = (screen_width-400)/2 + 400;
	console.log(kf_position_left+"????");
	
//	popupDivHtml = '<div id="kfpopupDiv" onmousedown="MyMove.Move(\'kfpopupDiv\',event,1);"  style="z-index:10000;filter:alpha(opacity=90);position: absolute; top: '+position+'px; left: '+kf_position_left+ 'px; color:#000;font-size: 12px;cursor:move;height: 150px;width: 340px;">';
	popupDivHtml = '<div id="kfpopupDiv" onmousedown="MyMove.Move(\'kfpopupDiv\',event,1);"  style="z-index:10000;filter:alpha(opacity=90);position: absolute; top:'
	+position+
	'px; left:'
	+kf_position_left+
	'px; color:#000;font-size: 12px;cursor:move;height: 150px;width: 340px;">';
